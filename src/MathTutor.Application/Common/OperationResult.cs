...
{
    public static OperationResult Success(string message = "Готово.") => new(true, message);
...
{
    public static OperationResult<T> Success(T value, string message = "Готово.") => new(true, message, value);
